...
- **Spike AA1 — Amplified actuator** → [`(https://github.com/SpikeDynamics/Spiketon-Actuators/tree/main/products/Spike%20AA1))] 
- **Spike AA2 — Amplified actuator** → [`(https://github.com/SpikeDynamics/Spiketon-Actuators/tree/main/products/Spike%20AA2)] 
